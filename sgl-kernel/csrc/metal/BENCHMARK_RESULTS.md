...
- Status: historical benchmark and environment reference.
- Use when: recovering early command patterns, environment variables, or
  pre-created MLX/Metal benchmark setup.
- Do not use as: the final performance claim. Open
  `METAL_FINAL_PERF_RESULTS_2026_05_11.md` for the final accepted table.
- Search tags: `benchmark-reference`, `historical`, `environment`,
  `commands`, `apple-silicon`.
