...
from sglang.kernels.metal import compile_metal_library, resolve_metal_entry_points
...
def _silu_and_mul_kernel():
    ...
    return resolve_metal_entry_points(library, ("silu_and_mul_bf16",))[0]


def warmup_silu_and_mul_metal_kernel() -> None:
    """Compile and resolve the entry point before serving traffic."""
...
def silu_and_mul(
    ...
    """Launch on the current MPS stream without copying or synchronizing."""
    if out is None:
...
__all__ = ["silu_and_mul", "warmup_silu_and_mul_metal_kernel"]
