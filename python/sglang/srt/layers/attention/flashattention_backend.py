        ...
        musa_ctx = (
            FlashAttentionContextManager(
                FlashAttentionContext(
                    device=self.device,
                    use_mla=self.use_mla,
                    num_hidden_layers=self.musa_flash_attn_with_kvcache_fwd_kwargs[
                        "num_hidden_layers"
                    ],
                    first_k_dense_replace=self.musa_flash_attn_with_kvcache_fwd_kwargs[
                        "first_k_dense_replace"
                    ],
                    full_attention_interval=self.musa_flash_attn_with_kvcache_fwd_kwargs[
