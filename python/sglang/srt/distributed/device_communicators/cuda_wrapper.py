...
_cudart_func_keys = [
    ...
    "cudaMalloc", "cudaFree", "cudaMemset", "cudaMemcpy", "cudaIpcGetMemHandle",
...
class CudaRTLibrary:
    exported_functions = [
        ...
        Function(
            cudart_func_map["cudaMemset"], cudaError_t, [ctypes.c_void_p, ctypes.c_int, ctypes.c_size_t]
        ),
    ...
    def __init__(self, so_file: Optional[str] = None):
        if so_file is None:
            ...
            assert so_file is not None, f"{lib_name} is not loaded in the current process"
