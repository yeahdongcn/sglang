...
_nccl_func_keys = [
    ...
    "ncclAllReduce", "ncclAllGather", "ncclReduce", "ncclReduceScatter",
    "ncclSend", "ncclRecv", "ncclBroadcast", "ncclCommDestroy",
    "ncclGroupStart", "ncclGroupEnd", "ncclCommWindowRegister", "ncclCommWindowDeregister"
]
...
class NCCLLibrary:
    exported_functions = [
        ...
        Function(nccl_func_map["ncclGetVersion"], ncclResult_t, [ctypes.POINTER(ctypes.c_int)]),
        # ncclResult_t ncclGetUniqueId(ncclUniqueId* uniqueId);
        Function(nccl_func_map["ncclGetUniqueId"], ncclResult_t, [ctypes.POINTER(ncclUniqueId)]),
    ...
    exported_functions_symm_mem = [
        ...
        Function(nccl_func_map["ncclCommWindowDeregister"], ncclResult_t, [ncclComm_t, ncclWindow_t]),
    ]
