...
SGLang Diffusion has no Apple-MPS-specific environment variable. It uses the
PyTorch MPS implementation directly and does not read the SRT
`SGLANG_MPS_*` model-operator priorities.
